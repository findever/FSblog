...
class PostModel extends Model {
	...
	protected $_validate = array(
		...
		array('post_cates', '/^(\d+,)*\d+$/', '分类值不正确', self::VALUE_VALIDATE, 'regex'),
	...
	protected $_auto = array(
		...
		array('post_remark','html_entity_decode',self::MODEL_BOTH,'function'),
		array('post_content','html_entity_decode',self::MODEL_BOTH,'function')
	);
